...
call <sid>hi("Search",        s:gui0A, s:gui00, s:cterm0A, s:cterm00,  "none")
...
hi Structure    NONE
hi Tag          NONE
call <sid>hi("Todo",         s:gui0A, s:gui00, s:cterm0A, s:cterm00, "bold")
hi Type         NONE
hi Typedef      NONE
...
" PHP highlighting
hi phpMemberSelector NONE
hi phpComparison NONE
hi phpParent NONE

" Python highlighting
hi pythonOperator NONE
hi pythonRepeat NONE

" Ruby highlighting
hi rubyAttribute NONE
hi rubyConstant NONE
hi rubyInterpolation NONE
hi rubyInterpolationDelimiter NONE
hi rubyRegexp NONE
hi rubySymbol NONE
hi rubyStringDelimiter NONE

" SASS highlighting
hi sassidChar NONE
hi sassClassChar NONE
hi sassInclude NONE
hi sassMixing NONE
hi sassMixinName NONE
